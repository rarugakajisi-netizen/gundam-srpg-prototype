...
window.GAME_DATA.skills = [
  ...
  },
  {
    ...
    "type": "機体/OP",
    "timing": "戦闘開始から初回行動まで",
    "effect": "移動または攻撃を行うまで、3マス以上離れた敵の射撃対象にならず、機体詳細も確認されない。敵偵察機の索敵範囲内や2マス以内では見破られる。",
    "implemented": true
  },
  {
    "id": "recon",
    ...
    "type": "機体/OP",
    "timing": "常時",
    "effect": "自機を中心とする索敵範囲内のステルス、ゲリラ戦術、煙幕などを看破し、味方全体が詳細確認と射撃を行える。索敵範囲は搭乗者の通信0～7で2マス、8～13で3マス、14～17で4マス、18以上で5マス。",
    "implemented": true
  },
  {
    "id": "antiSubmarine",
  ...
  },
  {
    ...
    "type": "機体/OP",
    "timing": "行動時",
    "effect": "1戦闘に1回、行動として発動し、看破状態を上書きして煙幕隠密になる。発動ターン中は敵偵察圏内でも隠密が保証されるが、次の自軍ターン開始時にも偵察圏内なら解除される。",
    "implemented": true
  },
  {
    "id": "antiAir",
  ...
  },
  {
    ...
    "type": "OP",
    "timing": "戦闘開始時",
    "effect": "戦闘開始時、現在隠密中で最もコストの高い敵MS1機を看破する。戦闘中に隠密を再発動されると上書きされる。",
    "implemented": true
  },
  {
    "id": "peaceWill",
  ...
  },
  {
    ...
    "type": "キャラ",
    "timing": "戦闘開始時",
    "effect": "自身がMSに搭乗している場合は搭乗機へ、ブリッジ要員の場合は味方MS1機へ初期ステルスを与える。",
    "implemented": true
  },
  {
    "id": "subFlightSystem",
    ...
    "type": "OP",
    "timing": "常時/被弾時",
    "effect": "移動力を大きく上げる。効果中は格闘武器を使えない。通常マップでは被ダメージまたは任意切り離しで効果を失う。空中マップでは搭乗機と耐久を共有し、被弾解除されない。飛行維持に必要な場合は切り離し不可。",
    "implemented": true
  },
  {
    "id": "rivalry",
  ...
  },
  {
    ...
    "type": "機体",
    "timing": "耐久低下時",
    "effect": "自機の耐久が3分の1以下になった時に発動。発動時に敵の隠密状態を看破し、回避・与ダメージが上昇する。看破後に隠密を再発動されると上書きされる。発動後、自軍ターン開始を3回迎えると耐久が大きく低下し、EN0になる。",
    "implemented": true
  },
  {
    "id": "zeusChargeBypass",
  ...
  },
  {
    ...
    "type": "武器",
    "timing": "行動時",
    "effect": "固定武装の使用回数を消費し、看破状態を上書きしてステルス状態へ移行する。発動ターン中は敵偵察圏内でも隠密が保証されるが、次の自軍ターン開始時にも偵察圏内なら解除される。",
    "implemented": true
  },
  {
    "id": "undergroundSonar",
    ...
    "type": "機体",
    "timing": "ターン終了時",
    "effect": "移動せずにターンを終了した場合、通信に応じた範囲内にいる全敵MSの隠密状態を看破し、自軍全体へ共有する。通常の偵察より範囲は1広いが、移動すると発動しない。看破後に隠密を再発動されると上書きされる。",
    "implemented": true
  },
  {
    "id": "phantomSystem",
