...
const BARRICADE_ARMOR = 100;
const PRIORITY_TARGET_ACCURACY_BONUS = 8;
const PRECISION_ATTACK_ACCURACY_BONUS = 12;
const PRECISION_ATTACK_DAMAGE_BONUS = 10;
const EMERGENCY_REPAIR_BASE = 30;
const EMERGENCY_REPAIR_MAINTENANCE_MULTIPLIER = 2;
const EMERGENCY_REPAIR_MAX_ARMOR_RATIO = 0.2;
const FORMATION_RANGE = 4;
const TRAIL_FORMATION_EVASION_BONUS = 5;
const TRAIL_FORMATION_DAMAGE_REDUCTION = 6;
const LINE_FORMATION_ACCURACY_BONUS = 5;
const LINE_FORMATION_DAMAGE_BONUS = 6;
const FORMATION_AI_POSITION_SCORE = 48;
const SUPPRESSIVE_FIRE_MAX_POWER = 45;
const SUPPRESSIVE_FIRE_EVASION_PENALTY = 8;
...
const isBarricade = (unit) => unit?.type === "barricade";
const isMobileSuit = (unit) => unit?.type === "mobileSuit";
const isCombatUnit = (unit) => isAlive(unit) && (isMobileSuit(unit) || isBattleship(unit));
const isAttackTarget = (unit) => isCombatUnit(unit) || (isAlive(unit) && (isDefenseTarget(unit) || isDestructionTarget(unit) || isBarricade(unit)));
