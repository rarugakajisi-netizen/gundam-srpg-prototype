...
,
  ...
  fordRomfellow: {
    attack: ["フォルド・ロムフェロー、前に出る！", "ここで押し切る。ルース、援護を頼む！"],
  ...
  miyuTakizawa: {
    attack: ["支援射撃を開始する。各機、射線に入らないで。", "照準データを送る。今なら当てられる。"],
    hit: ["命中確認。データは有効だったようね。", "よし、戦線を維持する。このまま続けて。"],
    miss: ["外れたか。座標を修正する。", "感情で急がないで。次は合わせる。"],
    move: ["補給線を維持する。フォルド、突出しすぎないで。", "安全なルートを提示する。各機、指示に従って。"],
    wait: ["整備と補給は確認済み。問題は、使う側の判断ね。", "機体は道具じゃない。無茶をすれば、必ずどこかに歪みが出る。"],
    evade: ["直撃は回避。通信系も生きている。", "危なかった……でも、まだ支援は続けられる。"],
    damaged: ["損傷確認。応急処置に入る。", "ここで諦めるつもりはない。全機、態勢を立て直して。"]
  },
  kirstenLombard: {
  ...
  annieBrevig: {
    attack: ["整備班だって、やる時はやります！", "機体の癖は分かっています。撃ちます！"],
    hit: ["当たりました！機体もちゃんと応えてくれています。", "よし、調整どおりです！"],
    miss: ["あれ、照準が少し甘い……？", "すぐ直します、次は当てます！"],
    move: ["無理な機動はしないでくださいね。後で整備が大変です。", "安全な場所へ移動します。"],
    wait: ["補給と冷却、確認しておきます。", "みんな無事で帰ってきてください。それが一番です。"],
    evade: ["わっ、危なかった……！", "機体の反応は良好です。助かりました！"],
    damaged: ["損傷箇所を記録します。まだ応急で動けます！", "壊さないでって言ったのに……でも、まだ大丈夫！"]
  },
  borkCry: {
  ...
  noctGadish: {
    ...
    wait: ["ピクシーの使用許可は出せん。現有戦力で対処しろ。", "損害が出ているからこそ、規律を崩すな。"],
  ...
  yuimanCarlile: {
    ...
    move: ["隊列を整える。リリア、ギュスター、遅れるな。", "前に出すぎた者を戻す。生き残るのも任務だ。"],
    wait: ["怒りに呑まれるな。マレットを止める役目も、我々にはある。", "教え子を犬死にさせるつもりはない。"],
  ...
  liliaFlobert: {
    ...
    move: ["援護できる位置へ移動します。", "ユイマン教官、指示をお願いします。"],
    wait: ["マレット隊長を止めるためにも、私たちが冷静でいないと。", "ギュスター、油断しないで。戦場なんだから。"],
    evade: ["見えました、回避します！", "危なかった……でも、まだ大丈夫です。"],
    damaged: ["被弾しました。でも、まだ戦えます！", "機体は動きます。退きません！"]
  },
  gusterPiper: {
    attack: ["ギュスター・パイパー、景気よく行くぜ！", "リリアにいいところ見せないとな！"],
    hit: ["へへっ、見たかよ！", "よし、俺だってやれるんだ！"],
    miss: ["うわ、今の外すか普通……！", "くそっ、次は当てる！"],
    move: ["前へ出る。援護、頼むぜ！", "写真に傷がつく前に片付ける！"],
    wait: ["焦るなって言われても、じっとしてるのは性に合わねえな。", "リリア、無茶するなよ。……って、俺が言う台詞じゃないか。"],
  ...
  jakeGuns: {
    ...
    move: ["隊に遅れるな。前線を合わせる。", "ヘンリー隊長、こちらも続きます！"],
    wait: ["焦らず隊長の指示を待つ。", "レイ、レスタ、突出するなよ。"],
