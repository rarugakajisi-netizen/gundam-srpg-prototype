...
,
  ...
  miyuTakizawa: {
    attack: ["支援射撃、入ります！", "データを送ります。今です！"],
    hit: ["命中確認です！皆さん、その調子で！", "よかった、支援データが合いました。"],
    miss: ["すみません、座標を修正します！", "もう一度、照準データを送り直します。"],
    move: ["補給線を維持します。無理はしないでください！", "安全なルートを探します。少し待ってください。"],
    wait: ["整備と補給、どちらも確認します。", "フォルドさん、ルースさん、機体を大事にしてくださいね。"],
    evade: ["危なかった……でも通信は生きています！", "回避成功です。支援を続けます！"],
    damaged: ["損傷確認、応急処置に入ります！", "まだ支援できます。諦めません！"]
  },
  kirstenLombard: {
